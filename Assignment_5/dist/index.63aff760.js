...
var _easterEggCollection = require("easter-egg-collection");
var _easterEggCollectionDefault = parcelHelpers.interopDefault(_easterEggCollection);

},{"easter-egg-collection":"4E7eb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4E7eb":[function(require,module,exports) {
module.exports = {
    pikachu: pikachu(),
    bravo: bravo(),
    ghost: ghost(),
...
function pikachu() {
    ...
    var pikachu = function() {
        ...
        window.setTimeout(function() {
            ...
            for(var x = 0; x < 81; x++)(function(x) {
                window.setTimeout(function() {
                    if (x % 2 === 0) shock.style.opacity = 0;
                    else shock.style.opacity = 0.3;
                }, x * 25);
            })(x);
        }, 2500);
        window.setTimeout(function() {
...
},{}]},["1JEHZ","adjPd"], "adjPd", "parcelRequire20ff")
